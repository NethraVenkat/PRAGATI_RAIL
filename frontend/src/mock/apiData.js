...
// Full Indian Railways Taxonomy — 19 Zones & Divisions
// Fully Aligned with 50-Field TDMS & 40-Field SMMS Schemas

export const ZONES = [
  { code: 'ALL', name: 'All India (19 Zones)', headquarters: 'Railway Board, New Delhi' },
...
export const SYSTEM_STATS = {
  ...
  approvedBlocks: 440,
  approvedBlocksTrend: '+92 approved across 19 zones',
  emergencyBlocks: 10,
...
// TMS Schema-Compliant Defects Dataset (Low, Medium, High, Critical)
export const TMS_DEFECTS = [
  {
    ...
    Task_Urgency_Tier: 'Tier 1 (Immediate - 24 Hours)',
    Planning_Horizon: 'Immediate 24 Hours',
  ...
  },
  {
    ...
    Task_Urgency_Tier: 'Tier 2 (High - 72 Hours)',
  ...
  {
    Defect_ID: 'TRK-2026-092',
    id: 'TRK-2026-092',
    department: 'TMS',
    deptLabel: 'Engineering (Track)',
    Section_ID: 'SEC-NDLS-CNB-UP',
    Station1: 'New Delhi (NDLS)',
    Station2: 'Kanpur Central (CNB)',
    Chainage_KM: '110.300',
    Latitude: '28.5210° N',
    ...
    Detection_Method: 'Track Recording Car',
    Reported_Date: '2026-09-01',
    location: 'NDLS-CNB Up Line (KM 110.300)',
    section: 'NDLS - CNB',
    zone: 'NR',
    division: 'DLI',
    status: 'Pending Block',
    Work_Due_Date: '2026-09-08',
    Overdue_Days: 0,
    Joint_Block_Feasibility_Score: 82.0,
    Task_Urgency_Tier: 'Tier 3 (Medium - Weekly Window)',
    Planning_Horizon: 'Monthly Schedule',
    Recommended_Block_Duration_Min: 180,
    Joint_Block_Recommendation: 'Combine with routine track tamping window',
    Priority_Score: 50.4,
    Priority_Class: 'Medium',
    Predicted_Resolution_Time_Hours: 3.0,
    Risk_If_Delayed: 'Accelerated Sleeper Wear & Ballast Cushion Settlement',
    Confidence_Score: '91.0%'
  },
  {
    Defect_ID: 'TRK-2026-095',
    id: 'TRK-2026-095',
    department: 'TMS',
    deptLabel: 'Engineering (Track)',
    Section_ID: 'SEC-NDLS-UMB-DN',
    Station1: 'New Delhi (NDLS)',
    Station2: 'Ambala Cantt (UMB)',
    Chainage_KM: '72.600',
    Latitude: '28.8120° N',
    Longitude: '77.0500° E',
    Asset_Type: 'Sleeper',
    Defect_Type: 'Missing/Loose Fastener',
    Severity_Level: 'Low',
    Detection_Method: 'Foot Patrol / Keyman',
    Reported_Date: '2026-09-02',
    location: 'NDLS-UMB Down Line (KM 72.600)',
    section: 'NDLS - UMB',
    zone: 'NR',
    division: 'DLI',
    status: 'Pending Block',
    Work_Due_Date: '2026-09-16',
    Overdue_Days: 0,
    Joint_Block_Feasibility_Score: 75.0,
    Task_Urgency_Tier: 'Tier 4 (Low - Routine Maintenance)',
    Planning_Horizon: 'Next Quarter',
    Recommended_Block_Duration_Min: 120,
    Joint_Block_Recommendation: 'Routine track gang maintenance without dedicated power block',
    Priority_Score: 27.6,
    Priority_Class: 'Low',
    Predicted_Resolution_Time_Hours: 2.0,
    Risk_If_Delayed: 'Minor Fastener Loosening over prolonged axle vibration',
    Confidence_Score: '88.5%'
  }
];

// Schema-Compliant 40-Field SMMS Signalling & Telecom Dataset (Low, Medium, High, Critical)
export const SMMS_DEFECTS = [
  {
    Defect_ID: 'SIG-2026-041',
    id: 'SIG-2026-041',
    department: 'SMMS',
    deptLabel: 'Signal & Telecom (S&T)',
    Detection_Method: 'Electronic Interlocking SSI Alarm',
    Reported_Date: '2026-08-30',
    Section_ID: 'SEC-NDLS-CNB-DN',
    Station1: 'New Delhi (NDLS)',
    Station2: 'Kanpur Central (CNB)',
    ...
    Zone: 'NR',
    Division: 'DLI',
    Asset_ID: 'SIG-SIG-041',
    Asset_Type: 'Color Light Signal',
    Defect_Type: 'Signal Lamp Failure',
    Severity_Level: 'Critical',
    location: 'NDLS-CNB Down Line (Signal S-14)',
    section: 'NDLS - CNB',
    status: 'Pending Block',
    Power_Supply_Type: '110V AC Signalling Power',
    Interlocking_Type: 'Electronic Interlocking (EI)',
    Communication_Link_Status: 'Down',
    Asset_Age_Years: 4.5,
    ...
    Priority_Class: 'Critical',
    Predicted_Resolution_Time_Hours: 3.0,
    Risk_If_Delayed: 'Immediate Signal Aspect Blanking & Automatic Train Stoppage',
    Confidence_Score: '96.5%',
    Joint_Block_Feasibility_Score: 94.0,
    Task_Urgency_Tier: 'Tier 1 (Immediate - 24 Hours)',
    Recommended_Block_Duration_Hours: 3.0,
    Joint_Block_Recommendation: 'Coordinate urgent disconnection with TMS Track & TDMS Power teams'
  },
  {
    ...
    Power_Supply_Type: '110V AC Signalling Power',
    Interlocking_Type: 'Electronic Interlocking (EI)',
    Communication_Link_Status: 'Degraded',
    Asset_Age_Years: 6.5,
    Historical_Failure_Count: 2,
    Overdue_Days: 0,
    ...
    Task_Urgency_Tier: 'Tier 2 (High - 72 Hours)',
    Recommended_Block_Duration_Hours: 3.0,
    Joint_Block_Recommendation: 'RECOMMENDED (Coordinate Disconnection Block with TMS Rail Weld & TDMS Power Block)'
  },
  {
    ...
    Asset_ID: 'SIG-AC-48A',
    Asset_Type: 'Point Machine',
    Defect_Type: 'Switch Blade Misalignment',
    Severity_Level: 'Medium',
    ...
    Risk_If_Delayed: 'Switch point clearance drift causing minor route setting delay',
    Confidence_Score: '91.2%',
    Joint_Block_Feasibility_Score: 84.5,
    Task_Urgency_Tier: 'Tier 3 (Medium - Weekly Window)',
    Recommended_Block_Duration_Hours: 2.5,
    Joint_Block_Recommendation: 'RECOMMENDED (Coordinate Disconnection with TDMS Catenary Repair)'
  },
  {
    Defect_ID: 'SIG-2026-063',
    id: 'SIG-2026-063',
    department: 'SMMS',
    deptLabel: 'Signal & Telecom (S&T)',
    Detection_Method: 'Periodic Diagnostic Test',
    Reported_Date: '2026-09-01',
    Section_ID: 'SEC-NDLS-UMB-DN',
    Station1: 'New Delhi (NDLS)',
    Station2: 'Ambala Cantt (UMB)',
    ...
    Division: 'DLI',
    Asset_ID: 'SIG-WS-94D',
    Asset_Type: 'Digital Axle Counter',
    Defect_Type: 'Wheel Sensor Fault',
    Severity_Level: 'Low',
    location: 'NDLS-UMB Down Line (KM 94.200)',
    section: 'NDLS - UMB',
    status: 'Pending Block',
    Power_Supply_Type: '24V DC Supply',
    Interlocking_Type: 'Electronic Interlocking (EI)',
    Communication_Link_Status: 'Healthy',
    Asset_Age_Years: 2.8,
    Historical_Failure_Count: 0,
    Overdue_Days: 0,
    Work_Due_Date: '2026-09-15',
    Work_Overall_Duration: 1.5,
    Work_Duration_Per_Day: 1.5,
    Section_Traffic_Density: 'MEDIUM (38 Trains/Day)',
    Corridor_Criticality: 'Medium',
    Available_Block_Window_Hours: 3.0,
    Priority_Score: 26.9,
    Priority_Class: 'Low',
    Predicted_Resolution_Time_Hours: 1.5,
    Risk_If_Delayed: 'Diagnostic voltage drift on redundant sensor channel',
    Confidence_Score: '89.4%',
    Joint_Block_Feasibility_Score: 76.0,
    Task_Urgency_Tier: 'Tier 4 (Low - Routine Maintenance)',
    Recommended_Block_Duration_Hours: 1.5,
    Joint_Block_Recommendation: 'Routine S&T technician inspection during standard shadow window'
  }
];

// Schema-Compliant 50-Field TDMS Traction Dataset (Low, Medium, High, Critical)
export const TDMS_DEFECTS = [
  {
    ...
    Joint_Block_Recommendation: 'RECOMMENDED (Merge Power Block with TMS Rail Weld TRK-081 & SMMS Signal Disconnection SIG-041)'
  },
  {
    ...
    Task_Urgency_Tier: 'Tier 2 (High - 72 Hours)',
    Recommended_Block_Duration_Min: 240,
    Joint_Block_Recommendation: 'RECOMMENDED (Merge Power Block with TMS Ballast Screening & SMMS Axle Counter SIG-042)'
  },
  {
    Defect_ID: 'TRC-2026-045',
    id: 'TRC-2026-045',
    department: 'TDMS',
    deptLabel: 'Traction Distribution (OHE)',
    Detection_Method: 'Tower Wagon Laser Measurement',
    Reported_Date: '2026-09-01',
    Section_ID: 'SEC-NDLS-CNB-UP',
    Station1: 'New Delhi (NDLS)',
    Station2: 'Kanpur Central (CNB)',
    ...
    Division: 'DLI',
    Corridor_ID: 'COR-NDLS-CNB-01',
    Asset_ID: 'OHE-CW-118/10',
    Asset_Type: 'Contact Wire',
    Defect_Type: 'Contact Wire Wear',
    Severity_Level: 'Medium',
    Latitude: '28.5600° N',
    Longitude: '77.2900° E',
    location: 'NDLS-CNB Up Line (Mast 118/10)',
    section: 'NDLS - CNB',
    status: 'Pending Block',
    Voltage_V: 24200,
    Current_A: 310,
    ...
    Traffic_Trains_Per_Day: 46,
    Goods_Trains_Forecast: 16,
    Route_Criticality: 'High',
    Work_Due_Date: '2026-09-08',
    Work_Overall_Duration: 3.0,
    Work_Duration_Per_Day: 3.0,
    ...
    Priority_Class: 'Medium',
    Predicted_Resolution_Time_Hours: 3.0,
    Risk_If_Delayed: 'Progressive Contact Wire Groove Wear beyond standard 12.24mm limit',
    Confidence_Score: '90.5%',
    Joint_Block_Feasibility_Score: 81.0,
    Task_Urgency_Tier: 'Tier 3 (Medium - Weekly Window)',
    Recommended_Block_Duration_Min: 180,
    Joint_Block_Recommendation: 'Schedule with routine corridor weekly maintenance possession'
  },
  {
    Defect_ID: 'TRC-2026-052',
    id: 'TRC-2026-052',
    department: 'TDMS',
    deptLabel: 'Traction Distribution (OHE)',
    Detection_Method: 'SCADA Telemetry Alert',
    Reported_Date: '2026-09-02',
    Section_ID: 'SEC-NDLS-UMB-DN',
    Station1: 'New Delhi (NDLS)',
    Station2: 'Ambala Cantt (UMB)',
    ...
    Division: 'DLI',
    Corridor_ID: 'COR-NDLS-UMB-02',
    Asset_ID: 'OHE-TSS-86/02',
    Asset_Type: 'Traction Substation',
    Defect_Type: 'Voltage Fluctuation',
    Severity_Level: 'Low',
    Latitude: '28.8900° N',
    Longitude: '77.0100° E',
    location: 'NDLS-UMB Down Line (TSS Sector 86/02)',
    section: 'NDLS - UMB',
    status: 'Pending Block',
    Voltage_V: 25100,
    Current_A: 230,
    ...
    Wind_Speed_kmh: 15,
    Weather_Condition: 'Clear',
    Traffic_Trains_Per_Day: 40,
    Goods_Trains_Forecast: 14,
    Route_Criticality: 'Medium',
    Work_Due_Date: '2026-09-16',
    Work_Overall_Duration: 2.0,
    Work_Duration_Per_Day: 2.0,
    Planning_Horizon: 'Next Quarter',
    Priority_Score: 28.2,
    Priority_Class: 'Low',
    Predicted_Resolution_Time_Hours: 2.0,
    Risk_If_Delayed: 'Transient voltage ripple on secondary feeder bus',
    Confidence_Score: '88.0%',
    Joint_Block_Feasibility_Score: 74.0,
    Task_Urgency_Tier: 'Tier 4 (Low - Routine Maintenance)',
    Recommended_Block_Duration_Min: 120,
    Joint_Block_Recommendation: 'Substation SCADA tap changer calibration without line shutdown'
  }
];
