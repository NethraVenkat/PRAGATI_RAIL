...
import { DigitalTwinPage, GISInfrastructureMapPage } from './pages/DigitalTwinPage';
                ...
                element={
                  ...
                  >
                    <Routes>
                      ...
                      <Route path="/DIGITAL_TWIN" element={<ProtectedRoute permissionPath="/digital-twin"><GISInfrastructureMapPage userRole={userRole} /></ProtectedRoute>} />
                      <Route path="/digital_twin" element={<ProtectedRoute permissionPath="/digital-twin"><GISInfrastructureMapPage userRole={userRole} /></ProtectedRoute>} />
